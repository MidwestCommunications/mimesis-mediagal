...
CREATE TABLE "mimesis_mediaupload" (
    ...
    "media_subtype" varchar(100) NOT NULL
)
;
### New Model: mimesis.MediaAssociation
...
CREATE INDEX "mimesis_mediaassociation_media_id" ON "mimesis_mediaassociation" ("media_id");
CREATE INDEX "mimesis_mediaassociation_content_type_id" ON "mimesis_mediaassociation" ("content_type_id");
